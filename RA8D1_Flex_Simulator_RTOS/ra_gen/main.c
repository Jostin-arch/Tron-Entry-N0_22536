...
#include "task.h"
#include "semphr.h"
extern void g_sensor_acquisition_thread_create(void);
extern TaskHandle_t g_sensor_acquisition_thread;
extern void g_sensor_acquisition_thread_create(void);
extern TaskHandle_t g_sensor_acquisition_thread;
extern void g_data_processing_thread_create(void);
extern TaskHandle_t g_data_processing_thread;
extern void g_graphics_update_thread_create(void);
extern TaskHandle_t g_graphics_update_thread;
...
int main(void)
{
    ...
    /* Init RTOS tasks. */
    g_sensor_acquisition_thread_create ();
    g_sensor_acquisition_thread_create ();
    g_data_processing_thread_create ();
    g_graphics_update_thread_create ();
